...
PHONE_NUMBER_TEXT = (
    ...
    "Including Country code. Example: **+1 415 456 XXXX**\n\n"
    "Press /cancel to Cancel Task."
)
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@StringSessionGenRobot](tg://openmessage?user_id=1472531255) \nA Bot By @HiTechRocket")
        await client.disconnect()
        text = "String Session is Successfully Generated.\nBy @HiTechRocket."
        reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="Check Your Saved Messege ✅", url=f"tg://openmessage?user_id={chat.id}")]]
        )
...
I will give you `STRING_SESSION` for your UserAccount.
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/HiTechRockets'),
                InlineKeyboardButton('Developer', url='https://t.me/Prabha_sha')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/HiTechRocket'),
            ]
        ]
    )
